...
public:
	...
	static const int CONSOLE_MONSTERS_HARD_LIMIT = 75;									// Max number of enemies (skeleton, zombie, creeper etc) that the mob spawner will produce
	static const int CONSOLE_ANIMALS_HARD_LIMIT = 75;									// Max number of animals (cows, sheep, pigs) that the mob spawner will produce	
	static const int CONSOLE_AMBIENT_HARD_LIMIT = 30;									// Ambient mobs

	static const int MAX_XBOX_CHICKENS = 16;										// Max number of chickens that the mob spawner will produce
	static const int MAX_XBOX_WOLVES = 16;										// Max number of wolves that the mob spawner will produce
	static const int MAX_XBOX_MUSHROOMCOWS = 8;									// Max number of mushroom cows that the mob spawner will produce
	...
	static const int CONSOLE_SQUID_HARD_LIMIT = 10;
	static const int MAX_CONSOLE_BOSS = 5;										// Max number of bosses (enderdragon/wither)
	
	static const int MAX_XBOX_ANIMALS_WITH_BREEDING = CONSOLE_ANIMALS_HARD_LIMIT + 125;	// Max number of animals that we can produce (in total), when breeding
	static const int MAX_XBOX_CHICKENS_WITH_BREEDING = MAX_XBOX_CHICKENS + 34;	// Max number of chickens that we can produce (in total), when breeding/hatching
	static const int MAX_XBOX_MUSHROOMCOWS_WITH_BREEDING = MAX_XBOX_MUSHROOMCOWS + 42;	// Max number of mushroom cows that we can produce (in total), when breeding
	static const int MAX_XBOX_WOLVES_WITH_BREEDING = MAX_XBOX_WOLVES + 34;		// Max number of wolves that we can produce (in total), when breeding
	static const int MAX_VILLAGERS_WITH_BREEDING = 150;
